        ...
        <div className="rounded-lg bg-slate-950 p-8 text-white sm:p-10 lg:p-12">
          <div className="grid gap-8 lg:grid-cols-[1fr_0.8fr] lg:items-center">
            ...
            <div className="grid gap-3">
              ...
              <a href="https://www.linkedin.com/in/christopher-maarschalkerweerd-4638b769/" target="_blank" rel="noreferrer" className="inline-flex items-center gap-3 rounded-lg border border-white/15 px-4 py-3 font-semibold text-white transition hover:bg-white/10">
